  ...
  return (
    <form className="mb-8 flex flex-wrap gap-3 rounded-2xl border border-[var(--afd-border)] bg-white p-4">
      <input
        ...
        className="min-w-0 w-full flex-1 rounded-lg border p-2 text-sm sm:min-w-[12rem]"
      />
      <input name="type" defaultValue={type} placeholder="Type (rapport…)" className={filterFieldClassName} />

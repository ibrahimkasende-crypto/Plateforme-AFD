...
## Méthode recommandée : GitHub (sans ZIP)

Voir le guide détaillé : [`HOSTINGER_GITHUB_AUTODEPLOY.md`](./HOSTINGER_GITHUB_AUTODEPLOY.md)

| Paramètre | Valeur |
|---|---|
| Type | Node.js Web App |
| Source | **Import Git repository** (pas ZIP) |
...
| Domaine | `afd-rdc.org` |
| Node | **22** ou **24** (voir `.nvmrc` et `package.json` engines `>=20 <=24`) |

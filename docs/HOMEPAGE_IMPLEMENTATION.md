...
## 18. À valider par le directeur

- Remplacement des visuels temporaires `adf1.jpg` / `adf2.png`
- Coordonnées téléphoniques définitives
- Premières publications (programmes, projets, actus, partenaires)
- Validation des textes institutionnels
